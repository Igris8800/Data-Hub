  ...
  python: {
    ...
    stages: [
      ...
      { id: "p2", title: "NumPy & pandas", belt: "Yellow", nodes: [
        ...
        { id: "pandas-io", title: "DataFrames: load, inspect, select", summary: "read_csv, head, info, loc/iloc, boolean masks.", points: ["df[df.col > 5]", ".loc uses labels, .iloc uses positions"], resources: [R("pandas — 10 minutes", "https://pandas.pydata.org/docs/user_guide/10min.html")], topics: ["pandas: inspect", "pandas: select", "pandas: filter", "pandas: sort", "pandas: new column", "pandas: value_counts", "pandas: export"] },
        { id: "groupby", title: "groupby, agg, merge, pivot_table", summary: "The SQL of pandas.", points: ["groupby('col').agg(total=('amt','sum'))", "merge(how='left')"], resources: [R("pandas — Group by", "https://pandas.pydata.org/docs/user_guide/groupby.html")], topics: ["pandas: aggregate", "pandas: groupby", "pandas: merge", "pandas: pivot", "pandas: reshape", "pandas: rank", "pandas: window", "pandas: share", "pandas: cohort", "pandas: RFM", "pandas: Pareto", "pandas: basket", "pandas: reviews", "pandas: performance"] },
      ]},
      { id: "p3", title: "Cleaning & analysis", belt: "Orange", nodes: [
        { id: "cleaning", title: "Missing values, types, strings, dates", summary: "fillna, astype, .str, to_datetime.", points: ["Never silently drop rows — count them first"], resources: [R("pandas — Working with text", "https://pandas.pydata.org/docs/user_guide/text.html")], topics: ["pandas: missing", "pandas: strings", "pandas: dates", "pandas: apply", "pandas: audit"] },
