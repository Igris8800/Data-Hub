  ...
  excel: {
    ...
    stages: [
      ...
      { id: "e3", title: "Conditional maths", belt: "Orange", nodes: [
        ...
        { id: "sumproduct", title: "SUMPRODUCT", summary: "Multiply arrays element-wise and add up — the Swiss-army knife for weighted sums and multi-condition maths.", points: ["(range=\"x\") produces TRUE/FALSE; multiply to make 1/0", "-- coerces booleans to numbers"], resources: [R("ExcelJet — SUMPRODUCT", "https://exceljet.net/functions/sumproduct-function")], topics: ["SUMPRODUCT", "Compliance", "Compa-ratio", "Bonus"] },
      ]},
